...
CloudDialog::CloudDialog( QVector<CoffeeRoastingProfile*> &queue, QProgressBar *progress_bar, QWidget *parent ) :
    QDialog(parent),
...
void CloudDialog::run_python( ) {
    ...
    QString py_path = "python";                                                     //save the absolute path to Python
